...
#+BEGIN_SRC emacs-lisp
  ...
  (ome-load "modules/jome-ess.org")
  (ome-load "modules/jome-files.org")
  (ome-load "modules/jome-pig.org")
  ;; (ome-load "modules/jome-sh.org")
  ;;(ome-load "modules/ome-tex.org")
  ;;(ome-load "modules/ome-web.org")
  ;;(ome-load "modules/ome-experimental.org" "smooth-scrolling" "sublimity")
  (ome-load "modules/jome-misc.org")

  (when (string= system-name "Jonass-MacBook-Pro.local")
    (ome-load "modules/jome-vinted.org"))
#+END_SRC
